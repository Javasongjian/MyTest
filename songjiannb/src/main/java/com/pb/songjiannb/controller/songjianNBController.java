package com.pb.songjiannb.controller;
...
@RestController
public class songjianNBController {

    private final Logger logger = LoggerFactory.getLogger(songjianNBController.class);
